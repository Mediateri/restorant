...
class LunchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lunch" do
    assert_difference('Lunch.count') do
      post lunches_url, params: { lunch: { cost: @lunch.cost, item: @lunch.item, restora_id: @lunch.restora_id } }
    end
  ...
  test "should update lunch" do
    patch lunch_url(@lunch), params: { lunch: { cost: @lunch.cost, item: @lunch.item, restora_id: @lunch.restora_id } }
